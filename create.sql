...
CREATE TABLE IF NOT EXISTS profesionales_de_la_salud(id INT PRIMARY KEY, dni VARCHAR(255), nombre VARCHAR(255), telefono VARCHAR(255), especialidad VARCHAR(255));
...
INSERT INTO profesionales_de_la_salud(id, dni, nombre, telefono, especialidad, profesion VARCHAR(255)) VALUES(1, '10', 'primero', '1234', 'GENERAL_PRACTICIONER', 'médico');
INSERT INTO profesionales_de_la_salud(id, dni, nombre, telefono, especialidad, profesion VARCHAR(255)) VALUES(2, '20', 'segundo', '2345', 'NONE', 'paramédico');
INSERT INTO profesionales_de_la_salud(id, dni, nombre, telefono, especialidad, profesion VARCHAR(255)) VALUES(3, '30', 'tercero', '3456', 'NONE', 'enfermero');
